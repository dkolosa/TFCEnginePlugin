...
Engine Model Plugin Samples written in C#.
...
6.	This plugin has already been registered in the "Engine Models" Category in the
	"Engine Models.xml" plugin point registration file; however the registration lies
	...
	<Plugin DisplayName = "CSharp Example1" ProgID = "AGI.Astrogator.Plugin.Examples.EngineModeling.CSharp.Example1"/>
...
9.  Use STK documentation for directions on how to configure an Engine Model Plugin for a 
    given satellite.
